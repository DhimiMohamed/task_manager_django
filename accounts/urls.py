...
from .views import UserRegistrationView, VerifyEmailView, UserLoginView, LogoutView, ProfileDetailView, RequestPasswordResetView, VerifyOTPView, ResetPasswordView, ResendVerificationEmailView
